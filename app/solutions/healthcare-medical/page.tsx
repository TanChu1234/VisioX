      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white rounded-2xl p-8 border border-stone-200 shadow-xl">
          <p className="text-xl text-stone-600 leading-relaxed max-w-3xl">
            Explore our Healthcare & Medical solutions. VisionX provides cutting-edge AI-powered tools tailored for professional computer vision workflows.
          </p>
          <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="p-6 bg-stone-50 rounded-xl border border-stone-100">
              ...
              <p className="text-stone-600">Comprehensive features designed to optimize your Healthcare & Medical processes with high efficiency and accuracy.</p>
            </div>
            <div className="p-6 bg-stone-50 rounded-xl border border-stone-100">
