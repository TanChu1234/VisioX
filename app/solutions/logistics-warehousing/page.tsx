          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-16">
            ...
            >
              ...
              <h1 className="text-5xl font-bold text-stone-900 leading-[1.1] mb-6">
                Optimizing <br /><span className="text-[#6735E0]">Logistics & Warehousing</span> <br />with Vision AI.
              </h1>
              <p className="text-xl text-stone-600 leading-relaxed mb-8 max-w-lg">
                VisioX provides the critical intelligence layer for logistics & warehousing, transforming visual data into actionable operational insights.
              </p>
            ...
            >
              <img src="https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?q=80&w=800" alt="Logistics & Warehousing" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-1000" />
              ...
              <div className="absolute bottom-8 left-8 right-8 p-6 bg-white/10 backdrop-blur-md rounded-2xl border border-white/20 text-white italic text-sm">
                "VisioX has fundamentally changed how we monitor our logistics & warehousing environments."
              </div>
            </motion.div>
          </div>
                ...
                <div className="flex flex-col justify-center">
                   <div className="p-10 bg-white/5 border border-white/10 rounded-[40px] backdrop-blur-sm">
                      <p className="text-stone-400 text-sm mb-8 leading-relaxed">
                        Ready to accelerate your logistics & warehousing digital transformation? 
