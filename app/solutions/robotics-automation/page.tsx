...
const config: SolutionPageConfig = {
    ...
    title: <>Visual Brain for <br /><span className="text-transparent bg-clip-text bg-gradient-to-r from-violet-600 via-purple-600 to-fuchsia-600">Autonomous Robots</span></>,
    ...
    heroCTAPrimary: "Request Solution Arch",
    heroCTASecondary: "Watch Tech Demo",
    ...
    capabilities: [
        { title: "6D Pose Estimation", description: "Precisely identify the position and orientation of parts for reliable robotic grasping.", icon: <Orbit className="w-6 h-6 text-violet-600" /> },
        { title: "Random Bin Picking", description: "Enable robots to pick unsorted, overlapping parts from deep bins with collision avoidance.", icon: <Box className="w-6 h-6 text-violet-600" /> },
        { title: "Autonomous Navigation", description: "Vision-based SLAM and obstacle detection for mobile robots in dynamic environments.", icon: <Move className="w-6 h-6 text-violet-600" /> },
        { title: "Path Optimization", description: "Real-time recalculation of robotic trajectories to avoid obstacles and reduce cycle time.", icon: <Maximize className="w-6 h-6 text-violet-600" /> }
    ],
