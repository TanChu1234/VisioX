...
export default function AnnotatePage() {
  ...
  const imageUrl = `https://picsum.photos/seed/${params.imageId}/1200/800`;
      ...
      <nav className="z-30 px-6 py-3 bg-stone-900/80 backdrop-blur-xl border-b border-white/5 flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
             ...
             <p className="text-[10px] font-bold text-orange-500 uppercase tracking-widest mt-1">Image: {params.imageId}</p>
          </div>
        </div>
