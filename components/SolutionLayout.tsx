...
const themeStyles = {
    violet: {
        ...
        button: "bg-violet-600 hover:bg-violet-500 shadow-[0_10px_30px_rgba(139,92,246,0.2)]",
    ...
    emerald: {
        ...
        button: "bg-emerald-600 hover:bg-emerald-500 shadow-[0_10px_30px_rgba(16,185,129,0.2)]",
    ...
    orange: {
        ...
        button: "bg-orange-600 hover:bg-orange-500 shadow-[0_10px_30px_rgba(249,115,22,0.2)]",
    ...
    rose: {
        ...
        button: "bg-rose-600 hover:bg-rose-500 shadow-[0_10px_30px_rgba(225,29,72,0.2)]",
    ...
    cyan: {
        ...
        button: "bg-cyan-600 hover:bg-cyan-500 shadow-[0_10px_30px_rgba(8,145,178,0.2)]",
